...
if(TRUE)
  set(raspicam_SOURCE_PREFIX /home/pi/catkin_ws/src/raspicam)
...
if(NOT "/home/pi/catkin_ws/src/raspicam/include" STREQUAL "")
  set(raspicam_INCLUDE_DIRS "")
  set(absolute_include_dirs "/home/pi/catkin_ws/src/raspicam/include")
  foreach(idir ${absolute_include_dirs})
    if(IS_ABSOLUTE ${idir} AND IS_DIRECTORY ${idir})
      set(include ${idir})
    elseif(IS_DIRECTORY /home/pi/catkin_ws/src/raspicam/${idir})
      set(include /home/pi/catkin_ws/src/raspicam/${idir})
    else()
      message(FATAL_ERROR "Project 'raspicam' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/pi/catkin_ws/src/raspicam/${idir}'.  Ask the maintainer 'pi <pi@todo.todo>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/pi/catkin_ws/devel/lib;/opt/ros/groovy/lib)
