...
(cl:defmethod cl:initialize-instance :after ((m <MotorCommand>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MotorCommand)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name tetrix_motors-msg:<MotorCommand> is deprecated: use tetrix_motors-msg:MotorCommand instead.")))

(cl:ensure-generic-function 'run_time-val :lambda-list '(m))
(cl:defmethod run_time-val ((m <MotorCommand>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tetrix_motors-msg:run_time-val is deprecated.  Use tetrix_motors-msg:run_time instead.")
  (run_time m))

(cl:ensure-generic-function 'motor_names-val :lambda-list '(m))
(cl:defmethod motor_names-val ((m <MotorCommand>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tetrix_motors-msg:motor_names-val is deprecated.  Use tetrix_motors-msg:motor_names instead.")
  (motor_names m))

(cl:ensure-generic-function 'motor_speeds-val :lambda-list '(m))
(cl:defmethod motor_speeds-val ((m <MotorCommand>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tetrix_motors-msg:motor_speeds-val is deprecated.  Use tetrix_motors-msg:motor_speeds instead.")
  (motor_speeds m))

(cl:ensure-generic-function 'motor_accelerations-val :lambda-list '(m))
(cl:defmethod motor_accelerations-val ((m <MotorCommand>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tetrix_motors-msg:motor_accelerations-val is deprecated.  Use tetrix_motors-msg:motor_accelerations instead.")
